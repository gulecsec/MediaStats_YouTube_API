    ...
    with channel_details:
        ...
        if page == "Views-Video Durations After":
            with channel_details:
                ...
                st.caption("""Based on the analysis of the data,

                it can be concluded that the number of videos uploaded by a news media channel does not necessarily have a direct correlation with the number of views received.
