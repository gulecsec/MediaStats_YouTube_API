...
<div class="footer">
<i class="fab fa-linkedin"></i><a style='display: inline; text-align: left;' href="https://www.linkedin.com/in/sgulec/" target="_blank">LinkedIn</a> and <i class="fab fa-github"></i><a style='display: inline; text-align: left;' href="https://github.com/gulecsec" target="_blank">GitHub</a> by gulecsec</p>
</div>
...
if page == "Turkish News Media's YouTube Stats":
    ...
    # Load Each Channel Monthly & Daily Data
    ...
    if page == "Comments per Video":
        ...
        title="Top Channels by Comments per Video: Analyzing Total Comments & Videos After 6th of Feb")
    ...
    if page == "Minutes per Video":
        ...
        title="Top Channels by Minutes per Video: Analyzing Total Minutes & Videos After 6th of Feb")
