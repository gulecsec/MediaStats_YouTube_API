...
if page == "Most Used Words Based on Content Title":
    with channel_details:
        ...
        if 'channel' in st.session_state and st.session_state.channel != channel_choice:
            st.session_state.chart_update = not st.session_state.chart_update

        if 'chart_update' not in st.session_state:
            st.session_state.chart_update = False

        st.session_state.channel = channel_choice

        st.pyplot(fig, clear_figure=st.session_state.chart_update)
